...
CREATE TABLE "public"."post_likes" (
    ...
    CONSTRAINT "post_likes_pkey" PRIMARY KEY ("user","post")
);
...
-- CreateTable
CREATE TABLE "public"."user_to_followee" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "user" UUID NOT NULL,
    ...
    CONSTRAINT "user_to_following_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "public"."user_to_follower" (
    "id" UUID NOT NULL DEFAULT gen_random_uuid(),
    "created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "user" UUID NOT NULL,
    ...
    CONSTRAINT "user_to_followers_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "public"."comments" ADD CONSTRAINT "comments_author_fkey" FOREIGN KEY ("author") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."comments" ADD CONSTRAINT "comments_post_fkey" FOREIGN KEY ("post") REFERENCES "public"."posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."post_likes" ADD CONSTRAINT "post_likes_post_fkey" FOREIGN KEY ("post") REFERENCES "public"."posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."post_likes" ADD CONSTRAINT "post_likes_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."posts" ADD CONSTRAINT "posts_author_fkey" FOREIGN KEY ("author") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."stories" ADD CONSTRAINT "stories_author_fkey" FOREIGN KEY ("author") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."user_to_followee" ADD CONSTRAINT "user_to_followee_followee_fkey" FOREIGN KEY ("followee") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."user_to_followee" ADD CONSTRAINT "user_to_followee_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."user_to_follower" ADD CONSTRAINT "user_to_follower_follower_fkey" FOREIGN KEY ("follower") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "public"."user_to_follower" ADD CONSTRAINT "user_to_follower_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;
